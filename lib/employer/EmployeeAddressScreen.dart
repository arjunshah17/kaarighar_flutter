...
class EmployeeAddressScreen extends StatefulWidget {


  @override
  _EmployeeAddressScreenState createState() => _EmployeeAddressScreenState();
}

class _EmployeeAddressScreenState extends State<EmployeeAddressScreen> {
...
String    currentLocationState=INStates.getName(loc.administrativeAreaLevel1.shortName)
,currentLocationCity=loc.city.shortName;
