...
class EmployerRegistration extends StatefulWidget {
  ...
  const EmployerRegistration(this._phoneNumber,this.firebaseUid) ;
  @override
  ...
  Future<void> makeRegister() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        setUserEmployee(response.data['token'], kRestaurant,response.data['user']);
